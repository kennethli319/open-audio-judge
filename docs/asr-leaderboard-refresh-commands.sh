...
.venv/bin/python scripts/refresh_asr_leaderboard_artifacts.py --check-only --require-generated-fresh --require-audio-ready --check-summary-out runs/asr-leaderboard/preflight-summary.json
.venv/bin/python scripts/refresh_asr_leaderboard_artifacts.py --check-only --require-generated-fresh --require-audio-ready --check-mlx-runtime --check-summary-out runs/asr-leaderboard/preflight-summary.json
